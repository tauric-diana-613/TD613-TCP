...
- Longer-shell transfer no longer defaults to additive glue. The engine now plans around relation opportunities like contrast, cause, time, and clarification, generates multiple deterministic candidates, and rejects candidates that collapse those relations into repetitive `and` joins.
