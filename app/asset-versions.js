(function () {
  ...
  window.TD613_ASSET_VERSIONS = {
    ...
    gatewayApertureDesktopAlign: '202606151850',
  ...
  document.write('<link rel="stylesheet" href="./gateway-aperture-desktop-align.css?v=' + (V.gatewayApertureDesktopAlign || V.gatewayHousekeeping || V.main || '') + '" />');
