(function () {
  ...
  function transformText(text, mod = {}, options = {}) {
    ...
    const transformStrength = options && options.profile ? Math.min(1, strength + 0.12) : strength;
    const blendedTargetProfile = options && options.profile
    ...
    const targetProfile = options && options.profile
      ...
      : blendedTargetProfile;
    const effectiveMod = options && options.profile
    ...
    const maxPasses = options && options.profile ? 3 : 3;
