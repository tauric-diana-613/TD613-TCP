...
// SOURCE: app/engine/data/discourse-ontology.js
...
const DISCOURSE_ONTOLOGY = Object.freeze({
...
const DISCOURSE_REGEX = Object.freeze({
...
const FORMALIZATION_FEATURE_RULES = Object.freeze([
  ...
  Object.freeze({ family: 'chatspeakShorthand', pattern: /\brn\b/gi, replacement: 'currently', label: 'feature:rn->currently' }),
  ...
  Object.freeze({ family: 'chatspeakShorthand', pattern: /\bperf\b/gi, replacement: 'performance', label: 'feature:perf->performance' }),
...
const DEGRADATION_FEATURE_RULES = Object.freeze([
  ...
  Object.freeze({ family: 'chatspeakShorthand', pattern: /\bcurrently\b/gi, replacement: 'rn', label: 'feature:currently->rn' }),
  ...
  Object.freeze({ family: 'chatspeakShorthand', pattern: /\bperformance\b/gi, replacement: 'perf', label: 'feature:performance->perf' }),
