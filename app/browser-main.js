(async function () {
  ...
  function normalizeGatewayApertureBridgeSummary(payload = {}) {
    ...
    return {
      ...
      mode: 'gateway-embed',
      type: 'status',
      apertureVersion: String(payload.apertureVersion || payload.version || latestPacket?.apertureVersion || latestPacket?.version || 'v3.0-alpha'),
      apertureSchema: String(payload.apertureSchema || payload.schemaVersion || latestPacket?.apertureSchema || latestPacket?.schemaVersion || 'td613-aperture/v3.0-alpha'),
      apertureFeatureVersion: String(payload.apertureFeatureVersion || latestPacket?.apertureFeatureVersion || 'v3.0-alpha-anti-epistemicide-research-runtime'),
