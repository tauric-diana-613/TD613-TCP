(async function () {
  ...
  function normalizeGatewayApertureBridgeSummary(payload = {}) {
    ...
    return {
      ...
      mode: 'gateway-embed',
      type: 'status',
      apertureVersion: String(payload.apertureVersion || payload.version || latestPacket?.apertureVersion || latestPacket?.version || 'v2.9.4'),
      apertureSchema: String(payload.apertureSchema || payload.schemaVersion || latestPacket?.apertureSchema || latestPacket?.schemaVersion || 'td613-aperture/v2.9.4'),
      apertureFeatureVersion: String(payload.apertureFeatureVersion || latestPacket?.apertureFeatureVersion || 'v2.9.4-sigma-dynamical-instrument'),
