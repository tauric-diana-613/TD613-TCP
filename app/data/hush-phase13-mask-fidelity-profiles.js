...
export const HUSH_PHASE13_MASK_FIDELITY_PROFILES = Object.freeze([
  ...
  profile('dromological-paul', 'PAUL', 'speed-pressure-chain', ['speed pressure', 'sequence velocity', 'temporal compression', 'diagnostic acceleration'], ['slow explainer', 'standard theory paragraph', 'padding'], ['fast chain', 'motion markers']),
