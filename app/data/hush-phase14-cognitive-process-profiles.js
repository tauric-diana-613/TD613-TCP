...
export const HUSH_PHASE14_COGNITIVE_PROCESS_PROFILES = Object.freeze([
  ...
  profile('dromological-paul', 'PAUL', 'velocity-chain', ['speed pressure', 'sequence acceleration', 'temporal compression', 'late diagnostic snap'], ['slow explainer', 'standard theory paragraph', 'padding', 'full stop conclusion'], ['then acceleration', 'speed matters', 'the sequence snaps']),
