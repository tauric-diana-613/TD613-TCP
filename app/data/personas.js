const personas = [
  ...
  },
  {
    ...
    chips: ['shorthand relay', 'donor-evidenced'],
    profileRecipe: {
      blend: [
        { sampleId: 'model-safety-rushed-mobile', weight: 0.3 },
        { sampleId: 'newsroom-correction-rushed-mobile', weight: 0.25 },
        { sampleId: 'performance-review-rushed-mobile', weight: 0.25 },
        { sampleId: 'mutual-aid-rushed-mobile', weight: 0.2 }
      ],
      overlayMod: {
        sent: -7,
        cont: 6,
