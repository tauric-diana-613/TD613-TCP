...
function loadA9Module() {
  ...
  if (!host.__td613AshA9ModulePromise) {
    host.__td613AshA9ModulePromise = import('./ash-a9-work-recompilation.js?v=20260724-a12-release-v1').catch(publishA9LoadHold);
  }
...
function loadA10Module() {
  ...
  if (!host.__td613AshA10ModulePromise) {
    host.__td613AshA10ModulePromise = import('./ash-a10-choir-recompilation.js?v=20260724-a12-release-v1').catch(publishA10LoadHold);
  }
...
function loadA11Module() {
  ...
  if (!host.__td613AshA11ModulePromise) {
    host.__td613AshA11ModulePromise = import('./ash-a11-capsule-recompilation.js?v=20260724-a12-release-v1').catch(publishA11LoadHold);
  }
