...
const INVESTIGATION = Object.freeze({
  ...
  routes: Object.freeze([
    ...
    route('encrypted_capsule', ['mandate', 'provenance', 'replication', 'findings', 'next', 'routes'], 'authorized-capsule-recipient', 'seal-replayable-custody-without-provider-packet', [ref('provenance', 'source digest registry'), ref('replication', 'deterministic replay receipt'), ref('findings', 'no intent finding'), ref('next', 'seal authorized Capsule')], '5f'),
