export const ASH_FLOWCORE_INGRESS_PORTAL_LOADER_VERSION = 'td613.ash.flowcore-ingress-portal-loader/v0.4-stage-owner-reacquisition';
...
if (!browser) {
  ...
  import('./ash-flowcore-ingress-portal.js?v=20260727-flowcore-stage-owner-v4')
    .then(module => {
      host.__td613AshFlowcoreIngressPortalLoader = Object.freeze({
        version:ASH_FLOWCORE_INGRESS_PORTAL_LOADER_VERSION,
        eligible:true,
