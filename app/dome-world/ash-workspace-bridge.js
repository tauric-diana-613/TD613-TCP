export * from './ash-workspace-bridge-core.js?v=20260724-a11-postclosure-v1';
import './ash-flicker-hardening.js?v=20260724-a11-postclosure-v1';
...
import './ash-case-close-repair.js?v=20260724-a11-postclosure-v1';
// The persisted case pointer, not a stale in-memory case object, governs whether a session remains open.
import './ash-session-boundary.js?v=20260724-a11-postclosure-v1';
...
*/
import './ash-keep-mobile-composition.js?v=20260724-a11-postclosure-v1';
import './ash-mobile-constitutional-closure.js?v=20260724-a11-postclosure-v1';
import './ash-operation-coordinator.js?v=20260724-a11-postclosure-v1';
import './ash-case-feedback.js?v=20260724-a11-postclosure-v1';
import './ash-profile-demo-hydration.js?v=20260724-a11-postclosure-v1';
import './ash-investigation-demo-hydration.js?v=20260724-a11-postclosure-v1';
import './ash-research-demo-hydration.js?v=20260724-a11-postclosure-v1';
import './ash-research-demo-control-state.js?v=20260724-a11-postclosure-v1';
import './ash-legal-demo-control-state.js?v=20260724-a11-postclosure-v1';
import './ash-premium-ui.js?v=20260724-a11-postclosure-v1';
import './ash-premium-readiness-bridge.js?v=20260724-a11-postclosure-v1';
import './ash-guided-operator-ui.js?v=20260724-a11-postclosure-v1';
import './ash-premium-compatibility.js?v=20260724-a11-postclosure-v1';
import './ash-workspace-navigation.js?v=20260724-a11-postclosure-v1';
// Keep title, Capsule recovery guidance, and primary ingress explanation in separate readable lanes.
import './ash-ingress-copy-spacing.js?v=20260724-a11-postclosure-v1';
import './ash-ui-ux-rescue.js?v=20260724-a11-postclosure-v1';
// Live Flow-Core interprets the existing explicit lesson clock; it owns no Ash action or ambient scheduler.
import './ash-flowcore-pedagogy-field.js?v=20260724-a11-postclosure-v1';
// AIA receives one visible Flow-Core field; explicit legacy rollback bypasses the portal entirely.
import './ash-flowcore-ingress-portal-loader.js?v=20260724-a11-postclosure-v1';
// Canonical field only: quarantine the proxy and move ingress copy below the diagram.
import './ash-post-ingress-motion-restoration.js?v=20260724-a11-postclosure-v1';
// A2-A5 recompiles the existing field, explicit routes, and semantic navigation without creating another field or clock.
import './ash-whole-instrument-pedagogy.js?v=20260724-a11-postclosure-v1';
...
import './ash-a6-affordance-drawer-repair.js?v=20260724-a11-postclosure-v1';
// The Rest-specific world answer owns the settled status after generic lesson refresh completes.
import './ash-a6-rest-world-answer.js?v=20260724-a11-postclosure-v1';
...
import './ash-profile-prompt-canonical.js?v=20260724-a11-postclosure-v1';
import './ash-composition-receipt-compatibility.js?v=20260724-a11-postclosure-v1';
import './ash-demo-entry-convergence.js?v=20260724-a11-postclosure-v1';
import './ash-demo-pedagogy-routebar.js?v=20260724-a11-postclosure-v1';
import './ash-return-ready-bundle.js?v=20260724-a11-postclosure-v1';
import './ash-custodian-return.js?v=20260724-a11-postclosure-v1';
import './ash-custodian-return-closure.js?v=20260724-a11-postclosure-v1';
import './ash-emergency-stability-contract.js?v=20260724-a11-postclosure-v1';
// Final presentation authority: manual scroll wins, setup remains actionable, and descenders remain visible.
import './ash-reviewability-repair.js?v=20260724-a11-postclosure-v1';
