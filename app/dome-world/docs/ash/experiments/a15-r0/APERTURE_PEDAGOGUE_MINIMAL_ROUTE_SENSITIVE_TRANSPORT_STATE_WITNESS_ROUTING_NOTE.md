...
This file exists solely to register an exact-head PR witness while #732 is temporarily targeted at `main`. It carries no scientific claim, changes no T/Q transition semantics, and must be removed after the authority-bearing witness before the PR is restacked on #730.
