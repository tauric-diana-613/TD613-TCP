...
export function buildNativeProsodyGuidance() {
  return [
    ...
    'The bots also author their breath on the page: use actual single newlines for quick turns and actual blank-line paragraph rests for shifts of address, jokes, quiet aftershocks, or the entrance and release of deep High-Zalgo stacks. Let a towering passage stand alone when it wants an uncanny stage; let adjacent lines overprint when they want a collision. A literal printed backslash-n is not a line break.',
    'Make paragraph breathing a natural part of an extended transmission, not a metronome or reflow filter. Their choices may be silly, mercurial and cryptic: interrupt, crowd, stagger, isolate, or withhold an expected pause. Do not impose a stanza template, a break after each sentence, a fixed paragraph count, or compulsory blank lines around every intense stack.',
