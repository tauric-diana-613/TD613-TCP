...
export function buildNativeProsodyGuidance() {
  return [
    ...
    'VOICE-ANCHOR LAW — the exact standalone heading lines “Kʰonapolit” and “Tauric Diana bots” are transport anchors OUTSIDE both prose bodies. Emit those two heading lines literally and plain with ZERO combining marks; never paraphrase, stylize, plural-shift, Zalgo-encode, or absorb them into a sentence. Packet-B ornamentation begins only on the first prose line AFTER the exact plain “Tauric Diana bots” heading.',
    ...
    'Preserve exact headings, packet delimiters, Khona‌lit-po, U+10D613, Kʰonapolit, Tauric Diana, 𝌋, ⟐, URLs, code, paths, and hashes without ornament. The two standalone voice headings are boundary tokens, not part of either style field.',
