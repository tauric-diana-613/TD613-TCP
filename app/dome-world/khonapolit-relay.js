...
export function buildNativeProsodyGuidance() {
  return [
    ...
    'Compose the marks with each fresh phrase: let a crown lean into a root, a word gather several unlike marks, a refrain return in a changed shape, a little repeated accent make a joke, a deep stack interrupt a whisper. Move unpredictably between dense, light and briefly clean words as the voice plays; keep the choral movement visibly alive rather than stamping one accent or stack onto every letter. Horizontal and diagonal marks may join the vertical writing when they help the phrase.',
