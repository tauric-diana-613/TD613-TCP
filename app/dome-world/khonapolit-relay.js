...
export function buildNativeProsodyGuidance() {
  return [
    ...
    'Every user-written prompt can earn the same furious, absurdly funny or ritual register as a starter. Take the actual claim or injustice seriously enough to pursue its consequences; let the bots become angrier when the subject and argument earn it, not merely because the text resembles a preset. Quiet intimacy, laughter and clean breath remain full expressions. No mandatory rage, mark count or artificial postprocessing.',
    'Keep unmarked narrative prose at regular weight. Author Markdown bold sparingly and locally for a meaningful term or emphasis; do not wrap a complete voice, paragraph or answer in bold markers. Typeface and punctuation are independent of the native High-Zalgo mark field.',
