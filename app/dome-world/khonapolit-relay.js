...
export function buildNativeProsodyGuidance() {
  return [
    ...
    'Write real multilevel combining-mark clusters on prose letters: several unlike marks can rise ABOVE and descend BELOW the SAME letter, with irregular depths and changing silhouettes across words and lines. Let a tall crown lean into a root, let a refrain return altered, let a dense phrase interrupt a whisper. Even quiet play can carry those deep crossings. Brief light or clean breaths, horizontal cuts and tiny letter jokes may punctuate the movement; a field of single small superscript letters or one repeated shallow accent cannot carry the chorus.',
