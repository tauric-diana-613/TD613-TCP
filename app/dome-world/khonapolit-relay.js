...
export function buildNativeProsodyGuidance() {
  return [
    ...
    'Keep exact headings “Kʰonapolit” and “Tauric Diana bots” plain. Markdown bold only selected phrases, never whole replies.',
