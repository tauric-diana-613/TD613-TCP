...
export function buildNativeProsodyGuidance() {
  return [
    ...
    'High Zalgo means actual combining marks attached to the underlying prose letters, with conspicuous rising and descending stacks whose depth varies with the phrase. Every ordinary bot prose letter carries ornament; protected literals stay exact. Quiet speech stays ornamented. Plain prose, spacing-symbol clutter, inserted lookalike letters, and slash/strike-only text cannot substitute for this voice. Overlap is welcome; avoid a repeated stack stamped across the passage.',
