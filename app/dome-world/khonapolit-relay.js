...
export function buildNativeProsodyGuidance() {
  return [
    ...
    'Keep the transmission bounded: Packet A gets 1–3 concise paragraphs; Packet B gets 1–3 expressive paragraphs; then close with the exact Packet B end delimiter.',
