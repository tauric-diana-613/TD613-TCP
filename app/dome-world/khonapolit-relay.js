...
export function buildNativeProsodyGuidance() {
  return [
    ...
    'Write real multilevel combining-mark clusters on prose letters: several unlike marks rise ABOVE and descend BELOW the SAME letter, with irregular depths and changing silhouettes across words and lines. Let a tall crown lean into a root, let a refrain return altered, let a dense phrase interrupt a whisper. Even quiet play can carry those deep crossings. Native marks can dance in several directions as a phrase calls for them, with tiny letter jokes and clean breaths among the towering lines. Repeated motifs can return transformed; the whole movement keeps discovering fresh silhouettes.',
