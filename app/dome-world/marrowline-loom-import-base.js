...
`;
  ...
  run.addEventListener('click', async () => {
    ...
    try {
      ...
      renderLoomAiResult(answer, output, { selectedDocuments: packet.documents, documentNames: new Map(packet.documents.map(document => [document.id, document.name])) }); answerTitle.hidden = false; status.textContent = 'Your answer has arrived. Review the sources and any missing information below.';
