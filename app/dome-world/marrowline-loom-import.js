...
export function mountMarrowlineLoomTask(root, packet, environment = window) {
  ...
  const cancel = add('button', 'Stop waiting'); cancel.id = 'loomImportedStop'; cancel.type = 'button'; cancel.hidden = true;
