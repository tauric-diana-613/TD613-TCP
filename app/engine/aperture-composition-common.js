...
export const APERTURE_COMPOSITION_PLAN_SCHEMA = 'td613.aperture.composition-constitution-plan/v0.1';
export const APERTURE_COMPOSITION_RECEIPT_SCHEMA = 'td613.aperture.composition-constitution-receipt/v0.1';
export const APERTURE_PRESENTATION_PROJECTION_SCHEMA = 'td613.aperture.composition-constitution-projection/v0.1';
export const APERTURE_COMPOSITION_REPLAY_SCHEMA = 'td613.aperture.composition-constitution-replay/v0.1';

export const APERTURE_COMPOSITION_DOMAINS = Object.freeze({
  plan: 'TD613:APERTURE:COMPOSITION-CONSTITUTION-PLAN:v1',
  receipt: 'TD613:APERTURE:COMPOSITION-CONSTITUTION-RECEIPT:v1',
  projection: 'TD613:APERTURE:COMPOSITION-CONSTITUTION-PROJECTION:v1',
  replay: 'TD613:APERTURE:COMPOSITION-CONSTITUTION-REPLAY:v1'
});
...
export function rejectCompositionAuthorityClaims(value) {
  ...
  if (paths.length) throw new Error(`Aperture composition constitution cannot acquire execution authority: ${paths.join(', ')}`);
}
