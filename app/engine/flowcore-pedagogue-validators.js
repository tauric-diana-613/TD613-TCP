...
import { EVIDENCE_LEVELS, FLOWCORE_AIA_ROUTE_IDS, OBSERVATION_STATUSES, PEDAGOGICAL_SCENE_SCHEMA, PEDAGOGICAL_TRANSITION_SCHEMA, PEDAGOGUE_PHASES, SCENE_KINDS, STATIONS, TERMINAL_PHASES } from './flowcore-pedagogue-law.js';
...
export function validateScene(scene) {
  ...
  if (!SCENE_KINDS.includes(scene.scene_kind) || !STATIONS.has(scene.station_owner) || !EVIDENCE_LEVELS.includes(scene.source_status) || !OBSERVATION_STATUSES.includes(scene.observation_status)) throw new Error('Scene jurisdiction or status is invalid.');
