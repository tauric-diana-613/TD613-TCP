...
export const HUSH_MASK_STUDIO_VERSION = 'phase-16-pr148-protected-authorship';
...
function normalizeProfileTargets(profileTargets = {}, distribution = {}) {
  ...
  return {
    ...
    centroid,
    toleranceBands,
    targetFeatureWeights,
    diversityAxisTargets: profileTargets,
    limitations: [...asArray(distribution.limitations), 'Diversity profile targets were normalized into the mask distribution schema for Mask Studio compatibility.']
  };
}
