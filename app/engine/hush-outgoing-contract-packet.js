...
function eoRfdRouteState(input = {}) {
  ...
  return Object.freeze({
    ...
    aperture_context: Object.freeze({
      aperture_version: aperture.aperture_version || aperture.apertureVersion || 'v3.2-alpha',
      aperture_schema: aperture.aperture_schema || aperture.apertureSchema || 'td613-aperture/v3.2-alpha',
      aperture_feature_version: aperture.aperture_feature_version || aperture.apertureFeatureVersion || 'v3.2-alpha-typed-epistemic-deficit-and-stability-aware-widening-runtime',
