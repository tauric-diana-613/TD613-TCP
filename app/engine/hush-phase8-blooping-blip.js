...
export const BLOOPING_BLIP_THRESHOLDS = Object.freeze({
  ...
  hyperchat_distortion_score_min: 0.58,
  hyperchat_distortion_score_max: 1,
  casual_syntax_intensity_min: 0.4,
  future_slang_density_min: 0.18,
  future_slang_density_max: 0.56,
  stream_consciousness_score_min: 0.2,
  stream_consciousness_score_max: 0.62,
  grammar_collapse_without_damage_min: 0.72,
  technical_nomenclature_retention_min: 0.7,
  high_register_concept_retention_min: 0.74,
  epistemic_term_retention_min: 0,
  semiotic_term_retention_min: 0.66,
  custody_term_retention_min: 0.82,
  conceptual_skeleton_retention_min: 0.75,
  emotional_gravity_retention_min: 0.72,
  stakes_preservation_score_min: 0.7,
  joke_pressure_score_max: 0.2,
  gravity_to_joke_ratio_min: 1.8,
  seriousness_under_casual_surface_min: 0.72,
  custody_bundle_visibility_min: 0.82,
  anchor_density_per_token_min: 0.08,
  event_relation_retention_min: 0.76,
  claim_scope_retention_min: 0.58,
  ...
  function_word_signature_similarity_max: 0.55,
  punctuation_fingerprint_retention_max: 1,
  ...
  generic_helper_voice_score_max: 0.42,
...
export function applyBloopingBlipDecisionRules(decision = {}, featureVector = {}, thresholds = BLOOPING_BLIP_THRESHOLDS) {
  ...
  addMetricRule(lists, 'forced_youth_register_risk', (f.forced_youth_register_risk ?? 0) <= thresholds.forced_youth_register_risk_max);
