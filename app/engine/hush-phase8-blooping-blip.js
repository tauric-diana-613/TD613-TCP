...
export const BLOOPING_BLIP_THRESHOLDS = Object.freeze({
  ...
  hyperchat_distortion_score_max: 0.9,
  casual_syntax_intensity_min: 0.52,
  ...
  technical_nomenclature_retention_min: 0.78,
  high_register_concept_retention_min: 0.8,
  epistemic_term_retention_min: 0.72,
  semiotic_term_retention_min: 0.66,
  custody_term_retention_min: 0.82,
  conceptual_skeleton_retention_min: 0.84,
  ...
  function_word_signature_similarity_max: 0.4,
