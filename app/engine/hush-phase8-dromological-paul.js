...
export const DROMOLOGICAL_PAUL_THRESHOLDS = Object.freeze({
  ...
  ordinary_forum_cadence_score_min: 0.5,
  comment_thread_readability_min: 0.72,
  top_comment_explanatory_pull_min: 0.62,
  plain_language_anchor_score_min: 0.76,
  dromological_slowdown_score_min: 0.62,
  velocity_interruption_score_min: 0.48,
  anti_pileon_score_min: 0.38,
  anti_overclaim_score_min: 0.54,
  thread_reorientation_score_min: 0.58,
  information_decompression_score_min: 0.7,
  anti_compression_success_min: 0.68,
  source_relation_expansion_min: 0.67,
  explanatory_continuity_score_min: 0.7,
  no_new_fact_expansion_score_min: 0.94,
  human_quirk_density_min: 0.32,
  human_quirk_density_max: 0.72,
  minor_flaw_signature_score_min: 0.25,
  ...
  pseudonym_stability_score_min: 0.56,
  mask_level_repeatability_min: 0.45,
  source_idiolect_displacement_min: 0.72,
  cross_post_mask_consistency_min: 0.48,
  ...
  claim_scope_retention_min: 0.62,
  ...
  generic_helper_voice_score_max: 0.4,
