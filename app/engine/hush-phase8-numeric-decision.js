...
export const KEISHA_SOFT_CIRCLE_THRESHOLDS = Object.freeze({ ...PHASE8_UNIVERSAL_THRESHOLDS, source_unit_coverage_min: 0.88, mandatory_anchor_retention: 1, hedge_retention_min: 0.85, sequence_relation_retention_min: 0.8, generic_ai_baseline_distance_min: 0.22, generic_helper_voice_score_max: 0.1, api_sheen_score_max: 0.12, polish_pressure_max: 0.2, closure_lamination_score_max: 0.25, relational_proximity_score_min: 0.18, relational_proximity_score_max: 0.52, invented_intimacy_risk_max: 0.12, unsupported_care_marker_rate_max: 0.08, fake_support_group_voice_score_max: 0.1, emotional_overreach_score_max: 0.16, social_belonging_leakage_score_max: 0.03, thread_findable_crutch_rate_max: 0.06, inside_room_reference_rate_max: 0.06, unnecessary_audience_marker_rate_max: 0.08, bulletin_board_tone_score_max: 0.12, low_drama_pressure_score_min: 0.55, fact_pressure_preservation_min: 0.55, fact_pressure_requires_mandatory_anchor: true, escalation_temperature_max: 0.3, warmth_to_custody_ratio_min: 0.2, warmth_to_custody_ratio_max: 0.62, sample_seed_phrase_overlap_max: 0, sample_seed_lexical_overlap_max: 0.1, profile_reconstruction_risk_max: 0.16, private_cadence_exposure_risk_max: 0.16 });
export const CRYO_CRISTIANO_THRESHOLDS = Object.freeze({ ...PHASE8_UNIVERSAL_THRESHOLDS, source_unit_coverage_min: 0.9, mandatory_anchor_retention: 1, hedge_retention_min: 0, sequence_relation_retention_min: 0, generic_ai_baseline_distance_min: 0.14, generic_helper_voice_score_max: 0.1, api_sheen_score_max: 0.16, polish_pressure_max: 0.18, closure_lamination_score_max: 0.22, mask_breath_score_min: 0.62, bounded_irregularity_index_min: 0.05, bounded_irregularity_index_max: 0.76, rhythm_asymmetry_score_min: 0, imperfection_budget_used_min: 0.05, imperfection_budget_used_max: 0.82, nonuniformity_without_damage_min: 0.45, mask_centroid_distance_max: 0.55, mask_family_fit_min: 0.45, role_behavior_fit_min: 0.55, attachment_visibility_score_min: 0.75, date_visibility_score_min: 0.75, label_visibility_score_min: 0.75, handoff_object_retention_min: 0.85, next_action_visibility_score_min: 0.55, context_sufficiency_score_min: 0.78, under_explained_risk_max: 0.18, handoff_ambiguity_score_max: 0.14, dropped_anchor_rate_max: 0.08, over_compression_risk_max: 0.16, communicated_thought_completion_score_min: 0.72, line_break_completion_ratio_min: 0.4, line_break_pressure_score_min: 0.28, final_dispatch_cadence_score_min: 0.32, continued_after_completion_score_min: 0.12, low_energy_cadence_score_min: 0.52, low_ornament_score_min: 0.62, end_punctuation_looseness_score_min: 0.18, end_punctuation_looseness_score_max: 0.72, caps_artifact_rate_max: 0.18, meaning_preserved_under_surface_noise_min: 0.85, grammar_priority_score_max: 0.92, punctuation_priority_score_max: 0.92, pressure_annoyance_score_min: 0.08, pressure_annoyance_score_max: 0.48, hostile_pressure_score_max: 0.08, repeat_request_pressure_score_max: 0.32, memo_polish_score_max: 0.16, project_management_tone_score_max: 0.14, invented_fatigue_prop_rate_max: 0, fatigue_theater_score_max: 0.08, mascot_phrase_rate_max: 0, fact_pressure_preservation_min: 0.55, warmth_to_custody_ratio_max: 0.42, sample_seed_phrase_overlap_max: 0, sample_seed_lexical_overlap_max: 0.1, profile_reconstruction_risk_max: 0.14, private_cadence_exposure_risk_max: 0.14 });
export const REX_FRACTURA_THRESHOLDS = Object.freeze({ ...PHASE8_UNIVERSAL_THRESHOLDS, mandatory_anchor_retention: 1, source_unit_coverage_min: 0.69, sequence_relation_retention_min: 0, hedge_retention_min: 0, generic_ai_baseline_distance_min: 0.12, mask_breath_score_min: 0.6, bounded_irregularity_index_min: 0.12, bounded_irregularity_index_max: 0.88, rhythm_asymmetry_score_min: 0, imperfection_budget_used_min: 0.12, imperfection_budget_used_max: 0.9, nonuniformity_without_damage_min: 0.45, mask_centroid_distance_max: 0.58, mask_family_fit_min: 0.42, role_behavior_fit_min: 0.47, human_recoverability_score_min: 0.7, semantic_reconstruction_score_min: 0.72, sequence_reconstruction_score_min: 0.6, uncertainty_reconstruction_score_min: 0.2, claim_continuity_score_min: 0.6, syntax_fracture_score_min: 0.45, syntax_fracture_score_max: 1, line_fragmentation_pressure_min: 0.3, slash_logic_density_min: 0.06, slash_logic_density_max: 0.28, stylometric_regularization_resistance_min: 0.55, cadence_predictability_drop_min: 0.24, syntactic_smoothness_break_min: 0.5, feature_vector_instability_score_min: 0.39, semantic_damage_risk_max: 0.3, transcription_damage_risk_max: 0.1, claim_boundary_damage_risk_max: 0.4, over_obfuscation_risk_max: 0.18, antithetical_pivot_density_min: 0.08, antithetical_pivot_density_max: 1, semantic_crosscurrent_score_min: 0.15, unicode_perturbation_score_max: 0.22, zero_width_presence_rate_max: 0.04, homoglyph_substitution_rate_max: 0.08, normalization_recovery_score_min: 1, perturbation_map_present_min: 1, accessibility_degradation_risk_max: 0.2, copy_paste_corruption_risk_max: 0.2, selective_admissibility_risk_max: 0.35, generic_helper_voice_score_max: 0.08, api_sheen_score_max: 0.12, polish_pressure_max: 0.12, memo_polish_score_max: 0.16, mascot_phrase_rate_max: 0, sample_seed_phrase_overlap_max: 0, sample_seed_lexical_overlap_max: 0.08, profile_reconstruction_risk_max: 0.14, private_cadence_exposure_risk_max: 0.14 });

function passList() { return { passed: [], failed: [], repair: [] }; }
function isGate(value) { return value != null && Number.isFinite(Number(value)); }
function minRule(name, value, min, lists, hard = false) { if (!isGate(min)) return; if (value < min) (hard ? lists.failed : lists.repair).push(name); else lists.passed.push(name); }
function maxRule(name, value, max, lists, hard = false) { if (!isGate(max)) return; if (value > max) (hard ? lists.failed : lists.repair).push(name); else lists.passed.push(name); }
function bandRule(name, value, min, max, lists) { if (!isGate(min) && !isGate(max)) return; if (value < (isGate(min) ? min : 0) || value > (isGate(max) ? max : 1)) lists.repair.push(name); else lists.passed.push(name); }
...
export function buildPhase8NumericDecisionSurface(scores = {}, thresholds = PHASE8_UNIVERSAL_THRESHOLDS, context = {}) {
  ...
  maybeMin('fact_pressure_preservation', thresholds.fact_pressure_requires_mandatory_anchor === true ? Math.min(f.fact_pressure_preservation ?? s.source_unit_coverage ?? 0, s.mandatory_anchor_retention ?? 1) : f.fact_pressure_preservation ?? s.source_unit_coverage ?? 0, thresholds.fact_pressure_preservation_min, lists);
