...
import { PHASE8_UNIVERSAL_THRESHOLDS, GLITCHING_PIXIE_THRESHOLDS } from './hush-phase8-numeric-decision.js';
...
export async function buildStylometricPassport(maskRecord = {}, options = {}) {
  ...
  const passport = {
    ...
    role: maskRecord.intended_role || maskRecord.gallery_role || null,
