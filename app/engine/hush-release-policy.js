...
export const HUSH_RELEASE_POLICY_VERSION = 'phase-17';
...
export function buildReleasePolicy(input = {}) {
  ...
  const reasons = [...asArray(input.reasons), ...asArray(candidate.vetoes), ...asArray(candidate.warnings)];
  ...
  return {
    ...
    operatorMessage: hardBlocked
      ? 'Output blocked because meaning, protected literals, naturalness, or claim discipline failed.'
