...
const HELPER_WORDS = ['certainly', 'overall', 'ultimately', 'additionally', 'furthermore', 'polished', 'professional', 'streamlined', 'helpful', 'clearly', 'thoughtfully', 'wanted', 'remind', 'version', 'important'];
