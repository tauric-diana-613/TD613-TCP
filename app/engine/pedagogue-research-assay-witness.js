...
function reviewStatus(external, supported, counterexampled, inconclusive) {
...
function nextLearningAction(supported, counterexampled, inconclusive) {
...
export function reviewPedagogueResearchMechanism(hydration, witnesses = [], mechanismId) {
  ...
  const review = {
    ...
    learning_state: reviewStatus(external, supported, counterexampled, inconclusive),
    next_learning_action: nextLearningAction(supported, counterexampled, inconclusive),
    ...
    finding: relevant.length
      ? 'Internal bounded assay evidence has been attached to the hydrated transferable relation. The evidence may support, counterexample, or complicate the relation, but it cannot promote the relation into Pedagogue law.'
