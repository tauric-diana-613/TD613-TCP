...
export function syntacticBranchingDepth(text = '') {
...
export function lexicalEntropyScore(text = '') {
  const normalized = normalizeText(String(text || ''));
...
export function transitionVariance(text = '') {
  const normalized = normalizeText(String(text || ''));
  const sentences = sentenceSplit(normalized);
...
export class StylometricDeepMetrics {
