...
function installStyle(doc = document) {
  ...
  style.textContent = `
    ...
    .hush-input-control-rail #generateMaskedOutputBtn{grid-column:1/-1!important;min-height:2.72rem!important;border-radius:999px!important;padding:.6rem 1rem!important;text-align:center!important;text-transform:uppercase!important;letter-spacing:.22em!important;font-weight:900!important;font-size:.8rem!important;border:0!important;color:#071013!important;background:linear-gradient(105deg,#c69cff 0%,#89e7ff 52%,#a9f5ff 100%)!important;box-shadow:0 0 30px rgba(137,231,255,.26)!important;}
    ...
    .hush-input-control-rail #analyzeOutputBtn{border:1px solid rgba(137,255,240,.30)!important;color:#eafff5!important;background:rgba(5,9,20,.82)!important;box-shadow:none!important;}
    ...
    .hush-phase32-compact-actions #generateMaskedOutputBtn{display:none!important;}
    ...
    .hush-phase32-compact-actions #copyHushOutputBtn{grid-column:1/-1!important;width:100%!important;min-height:2.65rem!important;}
    ...
    @media(max-width:760px){
      .hush-input-control-rail{grid-template-columns:1fr 1fr!important;gap:.44rem!important;position:sticky!important;top:.45rem!important;z-index:20!important;padding:.15rem 0 .35rem!important;background:linear-gradient(180deg,rgba(4,7,17,.96),rgba(4,7,17,.68) 72%,rgba(4,7,17,0))!important;backdrop-filter:blur(10px)!important;}
      .hush-input-control-rail #generateMaskedOutputBtn{min-height:2.48rem!important;font-size:.72rem!important;}
      .hush-input-control-rail #analyzeOutputBtn,.hush-input-control-rail #hushPhase32ClearInput{min-height:2.05rem!important;font-size:.62rem!important;letter-spacing:.14em!important;}
...
function moveInputControls(doc = document) {
  ...
  if (transform && transform.parentElement !== rail) rail.appendChild(transform);
