const HUSH_READY_LITE_VERSION = 'ready-lite/v1';
...
window.addEventListener('load', () => setTimeout(check, 60), { once: true });
window.__TD613_HUSH_READY_LITE__ = { version: HUSH_READY_LITE_VERSION, ready, check, release };
