(function () {
  ...
  "generatedAt": "2026-04-23T03:30:05.838Z",
  "cases": {
    "package-handoff-formal-record-under-rushed-mobile": {
      ...
      "retrievalTrace": {
        ...
        "generatorVersion": "v2",
        "semanticAudit": {
          "propositionCoverage": 0.873,
          "actorCoverage": 0.758,
          "actionCoverage": 0.863,
          "objectCoverage": 0.792,
        ...
        "planSummary": {
          ...
          "structuralOperationsSelected": [
            ...
            "ontology:probe-evidence-decoupled"
          ],
          "lexicalRegisterOperationsSelected": [
            ...
            "feature:hallway-table->hall-table",
            ...
            "ontology:probe-tag-temporal-drift",
            "ontology:probe-clock-drift"
          ],
        ...
        "donorProgress": {
          ...
          "outputDonorDistance": 2.35,
          "donorImprovement": 2.119,
          "donorImprovementRatio": 0.474,
          "sourceOutputLexicalOverlap": 0.446
        },
        "candidateLedger": [
          {
            ...
            "ontologyAudit": {
              ...
              "semanticCoverage": {
                "propositionCoverage": 0.833,
                "actorCoverage": 0.746,
                "actionCoverage": 0.826,
                "objectCoverage": 0.747,
            ...
            "outputPreview": "the rush pkg addressed to her place wasnt presented for signature at her door. tag says attempted, no one buzzed her. pkg was instead left on the 2nd fl landing"
          },
          {
          ...
          },
          {
            ...
            "outputPreview": "the rush pkg addressed to her place wasnt presented for signature at her door. tag says attempted but no one buzzed her. pkg was instead left on the 2nd fl land"
          },
          {
            "id": "base:order-beat",
            "family": "order-beat",
          ...
          },
          {
            ...
            "outputPreview": "the rush pkg addressed to her place wasnt presented for signature at her door. no one buzzed her. tag says attempted. pkg was instead left on the 2nd fl landing"
          },
          {
            "id": "base:hybrid",
            "family": "hybrid",
    ...
    "package-handoff-rushed-mobile-under-formal-record": {
      ...
      "retrievalTrace": {
        ...
        "generatorVersion": "v2",
        "semanticAudit": {
          "propositionCoverage": 0.697,
          "actorCoverage": 1,
          "actionCoverage": 0.694,
          "objectCoverage": 0.575,
          "polarityMismatches": 0,
          "tenseMismatches": 1,
          "protectedAnchorIntegrity": 1,
          "clauseAudits": [
        ...
        "ontologyAudit": {
          ...
          "aperture": {
            ...
            "closureClass": "drift",
            "closureScore": 0.751,
            "historicalCrease": 0.046,
            "unfoldingEnergy": 0.093,
            "beaconStatus": "beacon-idle",
            "cumulativeNarrowing": 0.255,
            "dominantLoss": "retrieval gating"
          },
        ...
        "planSummary": {
          ...
          "structuralOperationsSelected": [
            "ledger-merge",
            "front-if",
            "lane:conditional-formalization",
            "lane:conditional-seam-repair",
            "lane:help-causality-restored",
            "lane:formal-record-polish",
            "repair:conditional-fragment-join",
          ...
          "lexicalRegisterOperationsSelected": [
            ...
            "feature:hall-table->hallway-table",
            "feature:wasnt->was-not",
            "expanded:slash-list->sentences",
            "lane:its-hers->it-was-hers",
            "lane:said-yes-it-was-hers->confirmed",
        ...
        "realizationSummary": {
          ...
          "lexemeSwaps": [
            ...
            {
              "from": "said yes it was hers",
              "to": "confirmed it was hers",
              "family": "lane"
            },
            {
            ...
            {
              "from": "2b package was not brought down.",
              "to": "The parcel addressed to 2B was not presented",
              "family": "surface"
            }
          ],
          "vernacularFeatureShift": {
            ...
            "falseDirtyFamilies": [],
            "donorFeatureAdherence": 1,
            "concealmentEffectiveness": 0.9091,
        ...
        "donorProgress": {
          "eligible": true,
          "sourceDonorDistance": 4.469,
          "outputDonorDistance": 0.718,
          "donorImprovement": 3.751,
          "donorImprovementRatio": 0.839,
          "sourceOutputLexicalOverlap": 0.295
        },
        "candidateLedger": [
          {
            "id": "base:syntax-shape",
            ...
            "ontologyAudit": {
              ...
              "semanticCoverage": {
                "propositionCoverage": 0.58,
                "actorCoverage": 1,
                "actionCoverage": 0.572,
                "objectCoverage": 0.506,
                "polarityMismatches": 0,
                "tenseMismatches": 1
              },
              "anchorIntegrity": {
              ...
              "aperture": {
                ...
                "closureClass": "drift",
                "closureScore": 0.681,
                "historicalCrease": 0.052,
                "unfoldingEnergy": 0.114,
                "beaconStatus": "beacon-idle",
                "cumulativeNarrowing": 0.255,
                "dominantLoss": "retrieval gating"
              },
            ...
            "outputPreview": "The parcel addressed to 2B was not presented for signature at the apartment door. The carrier tag stated \"attempted / no answer\" at 6:41 but no buzzer call was "
          },
          {
            "id": "base:hybrid",
            "family": "hybrid",
    ...
    "volunteer-cleanup-professional-message-under-rushed-mobile": {
      ...
      "retrievalTrace": {
        ...
        "candidateSummary": {
          ...
          "holdStatus": "landed",
          "averageToolabilityScore": 0.8002
        },
        "realizationSummary": {
          "transferClass": "structural",
          "borrowedShellOutcome": "structural",
        ...
        "donorProgress": {
          ...
          "outputDonorDistance": 4.338,
          "donorImprovement": 0.63,
      ...
      "retrievalTrace": {
        ...
        "realizationSummary": {
          ...
          "vernacularFeatureShift": {
            ...
            "falseDirtyFamilies": [],
            "donorFeatureAdherence": 1,
            "concealmentEffectiveness": 0.7143,
        ...
        "candidateLedger": [
          ...
          },
          {
            ...
            "vernacularFeatureShift": {
              ...
              "falseDirtyFamilies": [],
              "donorFeatureAdherence": 1,
              "concealmentEffectiveness": 0.5714,
              "surfaceMarkerCount": 3,
              "pressure": {
                "targetRegisterLane": "professional-message",
                "activeFamilies": [
                  "orthographyNoise",
    ...
    "committee-budget-formal-record-under-rushed-mobile": {
      ...
      "retrievalTrace": {
        ...
        "candidateSummary": {
          ...
          "holdStatus": "landed",
          "averageToolabilityScore": 0.7983
        },
        "realizationSummary": {
          "transferClass": "structural",
          "borrowedShellOutcome": "structural",
          ...
          "lexemeSwaps": [
            ...
            {
              "from": "The finance committee met at 4:05 PM to",
              "to": "the finance committee met later to review the",
              "family": "surface"
            }
          ],
          "vernacularFeatureShift": {
        ...
        "donorProgress": {
          ...
          "outputDonorDistance": 2.805,
          "donorImprovement": 1.348,
          "donorImprovementRatio": 0.325,
          "sourceOutputLexicalOverlap": 0.894
        },
        "candidateLedger": [
          {
            "id": "base:syntax-shape",
            ...
            "outputPreview": "the finance committee met later to review the bridge budget after central administration extended the hiring freeze thru Q3. the immediate effect is that the st"
          },
          {
            "id": "base:cadence-connector",
            "family": "cadence-connector",
    ...
    "committee-budget-rushed-mobile-under-formal-record": {
      ...
      "retrievalTrace": {
        ...
        "donorProgress": {
          "eligible": true,
          "sourceDonorDistance": 4.153,
          "outputDonorDistance": 3.095,
          "donorImprovement": 1.058,
        ...
        "candidateLedger": [
          ...
          },
          {
            ...
            "outputPreview": "Freeze runs through q3, and means coord line stays empty 12 more weeks unless we bridge it. If needed, do not fake that intake can run with no staffing hit, roo"
          }
        ],
        "generationDocket": {
          "status": "landed",
    ...
    "archive-grant-formal-record-under-rushed-mobile": {
      ...
      "retrievalTrace": {
        ...
        "candidateSummary": {
          ...
          "holdStatus": "landed",
          "averageToolabilityScore": 0.7753
        },
        "realizationSummary": {
          "transferClass": "structural",
          "borrowedShellOutcome": "structural",
        ...
        "donorProgress": {
          ...
          "outputDonorDistance": 5.536,
          "donorImprovement": 0.009,
          "donorImprovementRatio": 0.002,
          "sourceOutputLexicalOverlap": 0.944
        },
        "candidateLedger": [
          {
            "id": "base:syntax-shape",
    ...
    "adversarial-hearing-professional-message-under-rushed-mobile": {
      ...
      "retrievalTrace": {
        ...
        "donorProgress": {
          ...
          "outputDonorDistance": 2.275,
          "donorImprovement": 1.244,
          "donorImprovementRatio": 0.354,
    ...
    "adversarial-hearing-rushed-mobile-under-professional-message": {
      ...
      "retrievalTrace": {
        ...
        "donorProgress": {
          "eligible": true,
          "sourceDonorDistance": 3.519,
          "outputDonorDistance": 2.183,
          "donorImprovement": 1.336,
          "donorImprovementRatio": 0.38,
    ...
    "benefits-appeal-professional-message-under-rushed-mobile": {
      ...
      "retrievalTrace": {
        ...
        "donorProgress": {
          ...
          "outputDonorDistance": 3.837,
          "donorImprovement": 0.523,
          "donorImprovementRatio": 0.12,
          "sourceOutputLexicalOverlap": 0.899
        },
        "candidateLedger": [
          {
            "id": "base:syntax-shape",
            ...
            "outputPreview": "Hello appeals unit, im writing about case BA-4427 bc the suspension is rn framed as a missing-documents problem when the file shows a routing mismatch instead. "
          },
          {
            "id": "base:cadence-connector",
            "family": "cadence-connector",
            ...
            "outputPreview": "Hello appeals unit, im writing about case BA-4427 since the suspension is rn framed as a missing-documents problem when the file shows a routing mismatch instea"
          },
          {
            "id": "base:order-beat",
            "family": "order-beat",
            ...
            "outputPreview": "Bc the suspension is rn framed as a missing-documents problem when the file shows a routing mismatch instead, hello appeals unit, im writing about case BA-4427."
          },
          {
            "id": "base:clause-pivot",
            "family": "clause-pivot",
          ...
          },
          {
            ...
            "outputPreview": "When the file shows a routing mismatch instead, hello appeals unit, im writing about case BA-4427 since the suspension is rn framed as a missing-documents probl"
          }
        ],
        "generationDocket": {
          "status": "landed",
    ...
    "museum-fog-alarm-professional-message-under-rushed-mobile": {
      ...
      "retrievalTrace": {
        ...
        "donorProgress": {
          ...
          "outputDonorDistance": 2.586,
          "donorImprovement": 2.029,
          "donorImprovementRatio": 0.44,
        ...
        "candidateLedger": [
          {
            ...
            "outputPreview": "production team, quick correction from Gallery 4: the fog cue later is what tripped the detector, not an electrical issue. facilities reset the panel and we res"
          },
          {
            "id": "base:cadence-connector",
            "family": "cadence-connector",
          ...
          },
          {
            ...
            "outputPreview": "production team, quick correction from Gallery 4: the fog cue later is what tripped the detector, not an electrical issue, but the real problem is that the cue "
          }
        ],
        "generationDocket": {
          "status": "landed",
    ...
    "model-safety-rushed-mobile-under-professional-message": {
      ...
      "retrievalTrace": {
        ...
        "candidateSummary": {
          ...
          "holdStatus": "landed",
          "averageToolabilityScore": 0.7238
        },
        "realizationSummary": {
        ...
        "candidateLedger": [
          ...
          },
          {
            ...
            "targetRegisterLane": "professional-message",
            "score": 0.4823,
            "toolabilityScore": 0.5694,
            "rewriteStrength": 0.292,
            "targetFit": 0.4047,
    ...
    "newsroom-correction-professional-message-under-rushed-mobile": {
      ...
      "retrievalTrace": {
        ...
        "donorProgress": {
          ...
          "outputDonorDistance": 2.771,
          "donorImprovement": 0.849,
          "donorImprovementRatio": 0.235,
