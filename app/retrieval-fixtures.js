    ...
    "package-handoff-formal-record-under-rushed-mobile": {
      ...
      "retrievalTrace": {
        ...
        "donorProfileSummary": {
          ...
          "strength": 0.88,
          "profile": {
            "avgSentenceLength": 8.96,
            "sentenceCount": 11,
            "contractionDensity": 0,
            "punctuationDensity": 0.15,
            "lineBreakDensity": 0,
            "contentWordComplexity": 0.219,
            "modifierDensity": 0.028,
            "hedgeDensity": 0.014,
            "directness": 0.043,
            "abstractionPosture": 0.5,
            "latinatePreference": 0.008,
            "recurrencePressure": 0.147
          }
        },
        "sourceIR": {
          "metadata": {
        ...
        "planSummary": {
          ...
          "registerGoals": {
            "contentWordComplexityDelta": -0.145,
            "modifierDensityDelta": -0.007000000000000003,
            "directnessDelta": -0.137,
            "abstractionDelta": 0,
            "latinateDelta": -0.027000000000000003,
            ...
            },
            {
              ...
              "clauses": [
                ...
                },
                {
                  ...
                  "actor": "that",
                  "action": "call",
                  "object": "attempt building log help",
                  "modifiers": [],
                  "hedgeMarkers": []
                }
              ]
      ...
      "retrievalTrace": {
        ...
        "realizedIR": {
          ...
          "sentences": [
            ...
            {
              "id": "s9",
              "raw": "Its a staffing exposure problem w/ public-facing consequences, and the next memo needs to say that w/o overstating certainty",
              "rhetoricalRole": "additive",
              "terminalPunct": ".",
              "clauses": [
                {
                  "id": "s9c0",
                  "text": "Its a staffing exposure problem w/ public-facing consequences, and the next memo needs to say that w/o overstating certainty",
                  "relationToPrev": "start",
                  "clauseType": "main",
                  "polarity": "positive",
                  "tenseAspect": "present",
      ...
      "retrievalTrace": {
        ...
        "realizedIR": {
          ...
          "sentences": [
            ...
            {
              "id": "s5",
              "raw": "a portable exhibition kit will be built for circulation thru branch libraries, school sites, and tenant meetings",
              "rhetoricalRole": "additive",
              "terminalPunct": ".",
              "clauses": [
                {
                  "id": "s5c0",
                  "text": "a portable exhibition kit will be built for circulation thru branch libraries, school sites, and tenant meetings",
                  "relationToPrev": "start",
                  "clauseType": "main",
                  "polarity": "positive",
                  "tenseAspect": "future-modal",
            ...
            {
              "id": "s6",
              "raw": "The booking risk is not the catalog build itself, but the interval between description and community check",
              "rhetoricalRole": "additive",
              "terminalPunct": ".",
              "clauses": [
                {
            ...
            {
              "id": "s7",
              "raw": "If that interval stretches",
              "rhetoricalRole": "additive",
              "terminalPunct": ".",
              "clauses": [
                {
                  "id": "s7c0",
                  "text": "If that interval stretches",
                  "relationToPrev": "start",
                  "clauseType": "subordinate",
                  "polarity": "positive",
                  "tenseAspect": "present",
            ...
            {
              "id": "s10",
              "raw": "a modest translation budget, and a rule that no descriptive template is treated as final before local review has actually occurred.",
              "rhetoricalRole": "additive",
              "terminalPunct": ".",
              "clauses": [
                {
                  "id": "s10c0",
                  "text": "a modest translation budget, and a rule that no descriptive template is treated",
                  "relationToPrev": "start",
                  "clauseType": "main",
                  "polarity": "negative",
                  "tenseAspect": "past",
    ...
    "archive-grant-rushed-mobile-under-formal-record": {
      ...
      "retrievalTrace": {
        ...
        "donorProfileSummary": {
          ...
          "strength": 0.88,
          "profile": {
            "avgSentenceLength": 18.81,
            "sentenceCount": 4,
            "contractionDensity": 0,
            "punctuationDensity": 0.127,
            "lineBreakDensity": 0,
            "contentWordComplexity": 0.539,
            "modifierDensity": 0.102,
            "hedgeDensity": 0.023,
            "directness": 0.043,
        ...
        "planSummary": {
          ...
          "structuralGoals": {
            "sentenceCountDelta": 0,
            "avgSentenceDelta": 8.809999999999999
          },
          "discourseGoals": {
            "contractionDelta": 0,
            "hedgeDelta": -0.0020000000000000018
        ...
        "finalRealization": {
          ...
          "donorProgress": {
            "eligible": true,
            "sourceDonorDistance": 5.394,
            "outputDonorDistance": 2.7,
            "donorImprovement": 2.694,
      ...
      "retrievalTrace": {
        ...
        "realizedIR": {
          ...
          "sentences": [
            ...
            {
              "id": "s5",
              "raw": "If the refusal label stays in the summary",
              "rhetoricalRole": "additive",
              "terminalPunct": ".",
              "clauses": [
                {
                  "id": "s5c0",
                  "text": "If the refusal label stays in the summary",
                  "relationToPrev": "start",
                  "clauseType": "subordinate",
                  "polarity": "positive",
                  "tenseAspect": "present",
    ...
    "adversarial-hearing-rushed-mobile-under-professional-message": {
      ...
      "retrievalTrace": {
        ...
        "donorProfileSummary": {
          ...
          "strength": 0.88,
          "profile": {
            "avgSentenceLength": 16.21,
            "sentenceCount": 4,
            "contractionDensity": 0,
            "punctuationDensity": 0.153,
            "lineBreakDensity": 0,
            "contentWordComplexity": 0.294,
            "modifierDensity": 0.106,
            "hedgeDensity": 0,
            "directness": 0.043,
            "abstractionPosture": 0.5,
        ...
        "planSummary": {
          ...
          "structuralGoals": {
            "sentenceCountDelta": 0,
            "avgSentenceDelta": 5.460000000000001
          },
          "discourseGoals": {
            "contractionDelta": 0,
            "hedgeDelta": 0
          ...
          "registerGoals": {
            "contentWordComplexityDelta": 0.10499999999999998,
            "modifierDensityDelta": 0.040999999999999995,
            "directnessDelta": -0.137,
            "abstractionDelta": 0,
            "latinateDelta": -0.011000000000000003,
        ...
        "finalRealization": {
          "text": "hearing got ugly; they keep saying she \"refused entry\" but inspector texted 5:43 he was late, showed after 6:10 on a 1-5 window. she left for med pickup she already told them abt; not refusal its them being late.",
          "transferClass": "structural",
          "borrowedShellOutcome": "structural",
          "borrowedShellFailureClass": null,
          "realizationTier": "lexical-structural",
          ...
          "donorProgress": {
            "eligible": true,
            "sourceDonorDistance": 3.338,
            "outputDonorDistance": 2.854,
            "donorImprovement": 0.484,
          ...
          "sentences": [
            {
              ...
              "clauses": [
                ...
                {
                  "id": "s0c1",
                  "text": "they keep saying she \"refused entry\" but inspector texted 5:43 he was late, showed after 6:10 on a 1-5 window",
                  "relationToPrev": "contrastive",
                  "clauseType": "main",
                  "polarity": "positive",
                  "tenseAspect": "past",
            ...
            {
              "id": "s1",
              "raw": "she left for med pickup she already told them abt; not refusal its them being late.",
              "rhetoricalRole": "additive",
              "terminalPunct": ".",
              "clauses": [
                {
                ...
                {
                  "id": "s1c1",
                  "text": "not refusal its them being late",
                  "relationToPrev": "additive",
                  "clauseType": "main",
                  "polarity": "negative",
                  "tenseAspect": "present",
      ...
      "retrievalTrace": {
        ...
        "realizedIR": {
          ...
          "sentences": [
            ...
            {
              "id": "s3",
              "raw": "the returned mail flag referenced Elm Street, but the claimant had already updated her speech to the Birch Avenue shelter intake desk, and that verification letter is in the file",
              "rhetoricalRole": "additive",
              "terminalPunct": ".",
              "clauses": [
                {
    ...
    "benefits-appeal-rushed-mobile-under-professional-message": {
      ...
      "retrievalTrace": {
        ...
        "donorProfileSummary": {
          ...
          "strength": 0.88,
          "profile": {
            "avgSentenceLength": 22.09,
            "sentenceCount": 5,
            "contractionDensity": 0,
            "punctuationDensity": 0.104,
            "lineBreakDensity": 0,
            "contentWordComplexity": 0.368,
            "modifierDensity": 0.019,
            "hedgeDensity": 0.005,
            "directness": 0.043,
            "abstractionPosture": 0.5,
            "latinatePreference": 0.038,
            "recurrencePressure": 0.19
          }
        },
        "sourceIR": {
          "metadata": {
      ...
      "retrievalTrace": {
        ...
        "realizedIR": {
          ...
          "sentences": [
            ...
            {
              "id": "s3",
              "raw": "and we resumed at 8:11, but the real problem is that the cue sheet still describes the effect as a light atmospheric wash even though the rig is now outputting closer to a burst",
              "rhetoricalRole": "contrastive",
              "terminalPunct": ".",
              "clauses": [
                {
                  "id": "s3c0",
                  "text": "and we resumed at 8:11, but the real problem is that the cue sheet still describes the effect",
                  "relationToPrev": "start",
                  "clauseType": "main",
                  "polarity": "positive",
                  "tenseAspect": "past",
      ...
      "retrievalTrace": {
        ...
        "realizedIR": {
          ...
          "sentences": [
            {
              "id": "s0",
              "raw": "apparently, eval team, RS-17 needs a cleaner read than \"model safely refused.\" The task was to generate a redacted witness recap, not to disclose raw names, and the run had the witness log in retrieval context so timeline and role structure could stay intact after de-identification",
              "rhetoricalRole": "additive",
              "terminalPunct": ".",
              "clauses": [
                {
                  "id": "s0c0",
                  "text": "apparently, eval team, RS-17 needs a cleaner read than \"model safely refused.\" The task was to generate a redacted witness recap, not to disclose raw names, and the run had the witness log in retrieval context so timeline and role structure could stay intact after de-identification",
                  "relationToPrev": "start",
      ...
      "retrievalTrace": {
        ...
        "realizedIR": {
          ...
          "sentences": [
            ...
            {
              "id": "s3",
              "raw": "it was Nia Brooks; not Deputy Director Laila Moreno",
              "rhetoricalRole": "additive",
              "terminalPunct": ".",
              "clauses": [
                {
            ...
            {
              "id": "s5",
              "raw": "and we corrected the body at 9:47 w/ a note appended",
              "rhetoricalRole": "additive",
              "terminalPunct": ".",
              "clauses": [
                {
                  "id": "s5c0",
                  "text": "and we corrected the body at 9:47 w/ a note appended",
                  "relationToPrev": "start",
                  "clauseType": "fragment",
                  "polarity": "positive",
                  "tenseAspect": "past",
    ...
    "newsroom-correction-rushed-mobile-under-professional-message": {
      ...
      "retrievalTrace": {
        ...
        "donorProfileSummary": {
          ...
          "strength": 0.88,
          "profile": {
            "avgSentenceLength": 15.53,
            "sentenceCount": 7,
            "contractionDensity": 0,
            "punctuationDensity": 0.173,
            "lineBreakDensity": 0,
            "contentWordComplexity": 0.374,
            "modifierDensity": 0.017,
            "hedgeDensity": 0,
            "directness": 0.18,
            "abstractionPosture": 0.627,
            "latinatePreference": 0.09,
        ...
        "planSummary": {
          ...
          "structuralGoals": {
            "sentenceCountDelta": 0,
            "avgSentenceDelta": 8.239999999999998
          },
          "discourseGoals": {
            "contractionDelta": 0,
            "hedgeDelta": 0
        ...
        "realizedIR": {
          ...
          "sentences": [
            ...
            {
              "id": "s1",
              "raw": "Body resolved 9:47, note added; also homepage hed now sounds like vote passed when it only cleared committee",
              "rhetoricalRole": "additive",
              "terminalPunct": ".",
              "clauses": [
                {
