...
export const SAFE_HARBOR_SURFACES = Object.freeze({
  ...
  packetVault: { id: 'packet-vault', label: 'Packet Vault', class: 'operator-only', copyPolicy: 'release-gated', claimLimit: true, controls: ['exportPacketPreview', 'copyPacketPreview', 'copyForensicSchemaPreview', 'openPacketTxtPreview'] },
...
export function buildSurfacePolicySummary() {
  return Object.freeze({ schema_version: 'td613.safe-harbor.surface-registry/v1', surfaces: SAFE_HARBOR_SURFACES, copy_export_control_map: COPY_EXPORT_CONTROL_MAP, claim_limits_required: true, raw_text_public_export: false, eo_shorthand: 'EO-RFD route firmware / hook lane' });
}
