...
The current Aperture protocol identity is `v3.1-alpha` /
`td613-aperture/v3.1-alpha`. The engine also exports
`v3.1-alpha-admissibility-tomography-registry-dynamics-runtime` as the Aperture feature posture
