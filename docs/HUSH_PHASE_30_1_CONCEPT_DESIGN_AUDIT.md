...
The audit uses Aperture v2.2.1 as a counter-tool frame: route state, layer visibility, self-test visibility, anti-enforcement posture, and export-gate legibility. Hush should preserve play while making custody, limits, and state visible.
