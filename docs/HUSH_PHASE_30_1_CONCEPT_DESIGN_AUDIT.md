...
The audit uses the Aperture counter-tool frame, now canonically v2.9.4 with doctrine-kernel and geometric-addendum posture: route state, layer visibility, self-test visibility, anti-enforcement posture, and export-gate legibility. Hush should preserve play while making custody, limits, and state visible.
