...
- `Dome-World / Flow-Core v0.6.0-alpha` is a non-public route-weather, sovereign-perspective, exact-residual, and Admissibility Tomography observatory coupled to Aperture v3.1-alpha through reciprocal receipts without reciprocal authority
