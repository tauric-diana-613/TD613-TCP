...
- `Dome-World / Flow-Core v0.5.0` is a non-public route-weather, sovereign-perspective, and exact-residual station coupled to Aperture v3.0-alpha through reciprocal receipts without reciprocal authority
