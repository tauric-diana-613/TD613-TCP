...
Public-default true or undefined, raw sample leak, raw candidate leak, mandatory anchor loss, new factual claim, claim inflation, wrong mask identity, public internal register, unclassified provider drift, fake runtime pass, fixture/live confusion, receipt-as-proof, Aperture-as-release-authority, missing non-claims, validator bypass, and collision severity 3 block release.
