# SRC operational research atelier
...
- `academia`: 499 targets (AUTH_REQUIRED=499)
- `doi`: 442 targets (VERIFIED_CAPTURE=442)
- `medium`: 210 targets (AUTH_REQUIRED=210)
- `substack`: 293 targets (PARTIAL=36, VERIFIED_CAPTURE=257)
- `zenodo`: 884 targets (VERIFIED_CAPTURE=884)

- captures: 1650
- unique content-addressed blobs: 1183
- searchable derivatives: 1650
- repeated-target observations preserved for recovery audit: 66
- rights states: {"PRIVATE_ONLY": 1002, "PUBLIC_ALLOWED": 1326}
