...
const RELEASE_EPOCH = '20260723-a2-a5-v1';
const RELEASE_CACHE_EPOCH = 'td613.ash.cache-flush/2026-07-23-a2-a5-v1';
...
const replacements = [
  [
    `const EPOCH = '${SOURCE_EPOCH}';`,
    `const EPOCH = '${RELEASE_EPOCH}';`
  ],
  [
    `const CACHE_EPOCH = '${SOURCE_CACHE_EPOCH}';`,
    `const CACHE_EPOCH = '${RELEASE_CACHE_EPOCH}';`
  ],
  [
