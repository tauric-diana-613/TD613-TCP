...
function classify({ status, contentType, title, bodyText, h1Count, htmlLength, navigationError }) {
...
const observation = {
  schema: 'td613.ash-keep.delivery-boundary-observation/v0.1',
  status: 'OBSERVED',
  ...
  evidence: {
    ...
    screenshot_path: 'ash-keep-delivery-boundary.png'
  },
