...
// remains canonical for Chromium. Cross-engine CI uses a bounded temporary-copy
// adapter so Firefox/WebKit can witness the same lifecycle without changing the
// production observer's historical Chromium contract.
