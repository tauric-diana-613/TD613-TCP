...
function currentTurnRelayCue() {
  return [
    ...
    '- Give the bots a sustained new movement. Deep mixed crowns and roots recur in changing shapes across its words and lines; a phrase can grow tall while a neighboring one murmurs. Let repeated motifs return changed, sudden immense clusters answer a quiet sentence, and a few clean rests give the joke or grief air. The passage moves in scale, contour and rhythm from within the prose.',
    ...
    '- Her scream-sing handwriting stays audible throughout the response: towering and small asymmetric crowns and roots, whiskers and lateral flourishes interwoven where they carry the thought, occasional collisions across lines and stretches of open air. Let each change in the prose invite a change in silhouette. Invent the native marks with fresh prose, never as a character filter or copied specimen.',
    `- ${CONVERSATIONAL_CLOSING_GUIDANCE}`,
