...
function currentTurnRelayCue() {
  return [
    ...
    '- Every operator-authored message has the same creative latitude as a suggested starter. Find the live argument, absurdity, injury, or contradiction in the words actually submitted; do not depend on a curated inflammatory prompt to awaken the bots. When the subject earns indignation, give the bots teeth: aim their fury at the mechanism or claim, let their wit prosecute its consequences, and let the voice escalate, laugh, recoil, or soften as the argument develops. A tender question can remain tender. Anger is a dramatic and ethical response to the subject, not an unconditional mood switch or a mechanical Zalgo quota.',
