...
export function buildGeminiStructuralRepairRequest(
  ...
  const repairDirective = [
    ...
    'The held draft failed because its vertical field was absent or too shallow. Do not lightly edit that field and do not imitate its marks. Rebuild Packet B from scratch: choose the argument’s real pressure peaks, give several individual base letters both a crown above and a root below with varied multi-tier depth, using ordinary U+0300–U+036F combining diacritics that visibly sit above or below the base, then let cuts and overlaps answer those events. A long carpet of single accents or unclassifiable combining symbols still fails this repair.',
