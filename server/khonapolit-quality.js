...
export function buildGeminiStructuralRepairRequest(
  ...
  const repairDirective = [
    ...
    'The held draft failed because its vertical field was absent or too shallow. Do not lightly edit that field and do not imitate its marks. Rebuild Packet B from scratch: choose the argument’s real pressure peaks, give several individual base letters both a crown above and a root below with varied multi-tier depth. Use only the accepted crown palette U+0301, U+0302, U+0307, U+0308, U+030B, U+030C, U+0310, U+0311 and accepted root palette U+0316, U+0317, U+0323, U+0324, U+0325, U+032C, U+032D; arbitrary U+0300–U+036F marks can be unclassifiable here. Then let cuts and overlaps answer those events. A long carpet of single accents or unclassifiable combining symbols still fails this repair.',
