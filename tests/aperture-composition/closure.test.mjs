...
for (const token of [
  'status: CLOSED', 'maturity: IMPLEMENTED_VALIDATION_GATED',
  'closure_observed_main_commit: e1fe108264045c4d75f0ef275b15654cf61b52a5',
  'runtime_run: 29514528199', 'runtime_artifact: 8382058122',
  'constitution_run: 29514528261', 'constitution_artifact: 8382057487',
  ...
  'deployment_earns_maturity: false', 'Stretch_6_authorized: false'
...
assert.match(stretch10, /production demonstration = NOT_CLAIMED/);
assert.match(stretch10, /One strategic Vercel deployment is authorized/);
