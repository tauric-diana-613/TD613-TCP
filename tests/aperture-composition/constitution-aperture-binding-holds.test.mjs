...
import { compileApertureCompositionReceipt } from '../../app/engine/aperture-composition-constitution.js';
...
console.log('aperture-composition/constitution-aperture-binding-holds.test.mjs passed');
