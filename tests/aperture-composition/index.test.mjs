...
const manifest = fs.readFileSync(new URL('../../app/aperture/composition.json', import.meta.url), 'utf8');
...
assert.match(bootstrap, /dispatchHeld/);
assert.match(bootstrap, /APERTURE_COMPOSITION_MANIFEST\.held_event/);
assert.match(manifest, /"held_event": "td613:aperture-composition-held"/);
