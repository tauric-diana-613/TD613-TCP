...
for (const marker of [
  'runDeterministicMoireAssay','compileReaderProfile','verifyMoireRebuildAssay','replayMoireRebuildAssay',
  'verifyMoireRebuildReplay','Pairwise residue ≠ intent','if (entries.length < 2)','storage was not mutated'
...
console.log(JSON.stringify({
  ok:true,schema:'td613.ash.a10-choir-contract/v0.1',singleton_first:true,residue_classes:RESIDUE_CLASSES_COUNT(),
  native_choir_preserved:true,native_rebuild_owner_preserved:true,active_render_owner:'NAMED_EVENTS_ONLY',
  ambient_subtree_observer:false,recurring_timer:false,automatic_assay:false,automatic_rebuild_test:false,
  human_interpretation_required:true,raw_content_transport:false,authority_changed:false,source_bytes_moved:false,
