...
assert.doesNotMatch(browserWrapper, /td613\.ash\.a12-entry-preflight\/v0\.3-present-state-canonical-field/);
assert.doesNotMatch(browserWrapper, /td613\.ash\.a12-browser-witness\/v1\.2-a15-present-state-canonical-field/);
...
console.log('Ash A12 command rationalization contract passed under present-state convergence, canonical-field settlement, and stateful failure diagnostics.');
