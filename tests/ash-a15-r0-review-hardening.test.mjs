...
const allowedCurrentChamberPaths = new Set([
  'app/dome-world/docs/ash/experiments/a15-r0/APERTURE_PEDAGOGUE_BOCKSTEIN_H3_EXT_TRANSGRESSION_SPEC_V0_1.md',
  'app/dome-world/docs/ash/experiments/a15-r0/APERTURE_PEDAGOGUE_BOCKSTEIN_H3_EXT_TRANSGRESSION_RECEIPT_V0_1.md',
  'app/dome-world/docs/ash/experiments/a15-r0/APERTURE_PEDAGOGUE_BOCKSTEIN_H3_EXT_TRANSGRESSION_WITNESS_ROUTING_NOTE.md',
  'app/dome-world/previews/a15-r0/aperture-pedagogue-bockstein-h3-ext-transgression.js',
  'tests/ash-a15-r0-aperture-pedagogue-bockstein-h3-ext-transgression.test.mjs',
...
await import('./ash-a15-r0-aperture-pedagogue-bockstein-h3-ext-transgression.test.mjs');
await import('./ash-a15-r0-wedding-identifiability.test.mjs');

console.log('Ash A15-R0 Bockstein H3 Ext transgression hardening tests passed.');
