...
const allowedCurrentChamberPaths = new Set([
  'app/dome-world/docs/ash/experiments/a15-r0/APERTURE_PEDAGOGUE_STIEFEL_WHITNEY_PIN_STRUCTURES_SPEC_V0_1.md',
  'app/dome-world/previews/a15-r0/aperture-pedagogue-stiefel-whitney-pin-structures.js',
  'tests/ash-a15-r0-aperture-pedagogue-stiefel-whitney-pin-structures.test.mjs',
...
await import('./ash-a15-r0-aperture-pedagogue-stiefel-whitney-pin-structures.test.mjs');
await import('./ash-a15-r0-wedding-identifiability.test.mjs');

console.log('Ash A15-R0 Stiefel-Whitney and Pin structure hardening tests passed.');
