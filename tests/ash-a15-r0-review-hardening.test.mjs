...
const allowedCurrentChamberPaths = new Set([
  'app/dome-world/docs/ash/experiments/a15-r0/APERTURE_PEDAGOGUE_PASTED_DIAMOND_DEFECT_TRANSPORT_SPEC_V0_1.md',
  'app/dome-world/docs/ash/experiments/a15-r0/APERTURE_PEDAGOGUE_PASTED_DIAMOND_DEFECT_TRANSPORT_RECEIPT_V0_1.md',
  'app/dome-world/docs/ash/experiments/a15-r0/APERTURE_PEDAGOGUE_PASTED_DIAMOND_DEFECT_TRANSPORT_WITNESS_ROUTING_NOTE.md',
  'app/dome-world/previews/a15-r0/aperture-pedagogue-pasted-diamond-defect-transport.js',
  'tests/ash-a15-r0-aperture-pedagogue-pasted-diamond-defect-transport.test.mjs',
...
await import('./ash-a15-r0-aperture-pedagogue-pasted-diamond-defect-transport.test.mjs');
await import('./ash-a15-r0-wedding-identifiability.test.mjs');

console.log('Ash A15-R0 pasted-diamond defect transport hardening tests passed.');
