...
for (const token of [
  ...
  'precommit_shadow_capture:true','full_control_parity:true','quiet_window_ms:SETTLEMENT_QUIET_MS','workshop_visible_after_restore:true',
