...
for (const token of [
  ...
  "const COMMIT_SELECTOR = '#ashA8CommitObject,#ashA8CommitRelation'",
  'let dirtyDraftActive = false','let recoveredInFlightRecompiles = 0','let recoverySerial = 0','function canonicalMapWorkshopIsActive()','function workshopIsConnected()','function custodyHoldIsActive()',
  ...
  '__td613AshA8RecompileGuard','shouldDefer','recover:recoverAfterInFlightRecompile','dirty_draft_active:dirtyDraftActive','workshop_connected:workshopIsConnected()','recovered_in_flight_recompiles:recoveredInFlightRecompiles','recovery_serial:recoverySerial','authority_changed:false','source_bytes_moved:false','human_closure_required:true'
