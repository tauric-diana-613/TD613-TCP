...
test('release journey adapts the retained AIA3 source to the exact A2-A5 delivery epoch and clean canonical URL', () => {
  ...
  assert.match(journeyWrapperSource, /const RELEASE_EPOCH = '20260723-a2-a5-v1'/);
  assert.match(journeyWrapperSource, /const RELEASE_CACHE_EPOCH = 'td613\.ash\.cache-flush\/2026-07-23-a2-a5-v1'/);
