...
assert.match(portal, /v0\.6-unique-play-hidden-proxy/);
...
assert.match(portal, /__td613AshFlowcoreField\?\.play\?\.\(\)/);
...
assert.match(portal, /node\.hidden = true/);
assert.match(portal, /node\.inert = true/);
