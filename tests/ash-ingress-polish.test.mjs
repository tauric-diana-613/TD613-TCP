...
assert.match(profilePrompt, /td613\.ash\.profile-prompt-canonical\/v0\.7-bounded-case-list-remount-reconciliation/);
...
assert.match(bridge, /ash-profile-prompt-canonical\.js\?v=20260723-profile-prompt-v3/);
