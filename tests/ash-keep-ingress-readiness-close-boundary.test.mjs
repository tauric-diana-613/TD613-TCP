...
assert.match(closeRepair, /td613\.ash\.case-close-repair\/v1\.5-save-population-serialized/);
...
assert.match(bridge, /ash-case-close-repair\.js\?v=20260723-case-close-refresh-v2/);
