...
assert(rescueSource.indexOf('dataset.ashUxScrollPending = name') < rescueSource.indexOf('dataset.ashUxScrollTarget = name'), 'Pending navigation must precede the settled target receipt.');
