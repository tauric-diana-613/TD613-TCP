...
assert.match(browserProbe, /v0\.6-flowcore-consequence-field/);
...
assert.match(browserProbe, /ashFlowcorePhase === 'REST'/);
assert.match(browserProbe, /artifact_required === false/);
assert.match(browserProbe, /Obsolete four-dot explanation track remained visible/);
