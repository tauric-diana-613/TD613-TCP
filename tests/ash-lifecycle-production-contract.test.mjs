...
for (const marker of [
  /Ash Lifecycle Deployed Observation/, /TD613 Ash · Threshold/, /name="ash-lifecycle" content="v0\.1"/,
  /Observe deployed Ash lifecycle without promotion/, /node scripts\/ash-lifecycle-production-probe\.mjs/
