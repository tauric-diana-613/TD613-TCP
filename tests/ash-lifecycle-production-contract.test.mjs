...
assert.match(ledger, /Stretch 4 · Hush Vocabulary Externalization And Lifecycle-Bound Intervention Ensemble[\s\S]*BLOCKED \/ NOT_AUTHORIZED/);
...
assert.ok(
  roadmap.indexOf('Stretch 2 · Custodian Return And Anisotropy — CLOSED') < roadmap.indexOf('Stretch 3 · Choir calibration receipt binding — CLOSED')
  && roadmap.indexOf('Stretch 3 · Choir calibration receipt binding — CLOSED') < roadmap.indexOf('Hush vocabulary externalization and intervention ensemble — BLOCKED'),
