...
const fixtureUrl = new URL('./ash-live-ingress-demos-cache-baseline.fixture.mjs', import.meta.url);
const generatedUrl = new URL('./.ash-live-ingress-a15-postclosure.generated.mjs', import.meta.url);
const replacements = [
