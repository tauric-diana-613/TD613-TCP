...
const ashLoader = read('app/dome-world/ash-keep.js');
const ashBase = read('app/dome-world/ash-keep-base.js');
...
assert.match(ashLoader, /import '\.\/ash-keep-base\.js';/);
assert.match(ashLoader, /import '\.\/ash-safe-harbor-ingress\.js';/);
assert.match(ashBase, /compileCaseMap/);
assert.match(ashBase, /compileRouteMemory/);
