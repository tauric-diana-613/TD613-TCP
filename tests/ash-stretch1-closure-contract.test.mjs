...
assert.match(ledger, /Ledger generation: `v1\.5 · Stretch 1 constitutional convergence closed`/);
...
assert.match(roadmap, /Roadmap generation: `v1\.5 · Stretch 1 closed \/ Stretch 2 awaiting approval`/);
...
assert.ok(roadmap.indexOf('Stretch 1 · Ash Constitutional Convergence Closure — CLOSED') < roadmap.indexOf('Stretch 2 · Custodian Return And Anisotropy — AWAITING OPERATOR APPROVAL'));
assert.ok(roadmap.indexOf('Stretch 2 · Custodian Return And Anisotropy — AWAITING OPERATOR APPROVAL') < roadmap.indexOf('Choir calibration receipt binding'));
assert.match(roadmap, /No Stretch 2 code, schema, sandbox database, Return UI, import path, comparison run, Anisotropy Receipt, test fixture, production probe, or maturity promotion has begun\./);
...
assert.match(receipt, /Stretch 2 · Custodian Return And Anisotropy[\s\S]*AWAITING_OPERATOR_APPROVAL \/ NOT_STARTED/);
