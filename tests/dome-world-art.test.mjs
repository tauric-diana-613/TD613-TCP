...
assert.equal(document.title, 'Dome-World');
assert.equal(document.querySelector('meta[name="td613-dome-world-version"]')?.content, 'v0.7.0-alpha');
assert.equal(release.domeWorld.version, 'v0.7.0-alpha');
assert.equal(release.domeWorld.schema, 'td613.dome-world/v0.7.0-alpha');
