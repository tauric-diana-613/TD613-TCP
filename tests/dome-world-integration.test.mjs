...
assert.match(vercel.functions['api/ash-local-commitment.py'].includeFiles, /ash_canonical_json\.py/);
assert.match(vercel.functions['api/ash-local-commitment-guard.py'].includeFiles, /ash_canonical_json\.py/);
