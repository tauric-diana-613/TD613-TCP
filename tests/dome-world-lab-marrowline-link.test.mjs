...
assert.equal(DOME_WORLD_SHELL_VERSION, 'td613.dome-world.shell/v1.6-legal-demo-ux');
...
console.log('dome-world-lab-marrowline-link: desktop span, embedded Ash membrane, Legal UX cache boundary, and mobile overrides ok');
