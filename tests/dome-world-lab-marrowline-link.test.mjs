...
assert.equal(DOME_WORLD_SHELL_VERSION, 'td613.dome-world.shell/v1.5-aia3-production-recovery');
...
console.log('dome-world-lab-marrowline-link: desktop span, embedded Ash membrane, AIA3 cache boundary, and mobile overrides ok');
