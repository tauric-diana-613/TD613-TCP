...
assert.equal(DOME_WORLD_SHELL_VERSION, 'td613.dome-world.shell/v1.7-ash-first-paint');
...
console.log('dome-world-lab-marrowline-link: desktop span, embedded Ash membrane, canonical first-paint boundary, and mobile overrides ok');
