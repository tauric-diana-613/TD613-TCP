...
assert.equal(vercel.functions['api/khonapolit-quality.js']?.maxDuration, 60);
...
before('/api/khonapolit', '/api/(.*)');
before('/api/dome-world/khonapolit', '/api/dome-world/(.*)');

for (const source of ['/api/hush-generate', '/api/hush-generate-budgeted', '/api/hush-generate-quality', '/api/gemini-readiness']) {
