...
assert.match(bootstrap, /giving-dossier-help\.js\?v=20260812-7/);
...
assert.match(dossierHelp, /giving-dossier-help\.css\?v=20260812-1/);
...
assert.match(dossierHelp, /setPopupOpen\(false\)/);
...
assert.match(dossierHelpCss, /\.research-dossier-help-popup \{[\s\S]*position:\s*absolute/);
assert.match(dossierHelpCss, /font-size:\s*7px/);
