...
assert.match(pageSize, /const FEC_BOUNDARY_PAGE_SIZE = 50;/, 'OpenFEC browser boundary must retain a small first-page evidence slice');
assert.match(pageSize, /const PAGE_SIZE = 50;/, 'non-FEC browser boundaries must retain the same bounded first-page evidence slice');
...
console.log('giving-fec-boundary-page.test.mjs passed: bounded browser evidence pages preserve explicit continuation and one-replay no-progress fuse.');
