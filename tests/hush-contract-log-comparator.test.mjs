...
function contract(overrides = {}) {
  return {
    ...
    eo_rfd_route_state: { firmware_status: 'interface-only', route_conscience_hook: 'required', aperture_context: { aperture_schema: 'td613-aperture/v2.9.2' } },
    ...overrides
  };
}
function log(overrides = {}) {
  return {
    ...
    eo_rfd_route_observation: { firmware_status: 'interface-only', route_conscience_hook_observed: 'required', firmware_adapter_verified: false, aperture_context: { aperture_schema: 'td613-aperture/v2.9.2' }, operator_note: 'interface only' },
    ...overrides
  };
}
...
assert.equal(compareEoRfdRoute(contract(), log()).contract_aperture_schema, 'td613-aperture/v2.9.2');
assert.equal(compareEoRfdRoute(contract(), log()).log_aperture_schema, 'td613-aperture/v2.9.2');
