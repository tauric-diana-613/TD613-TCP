...
const timers = [];
const context = { window: { __TD613_HUSH_SOURCE_LAYOUT_POLICY__: {}, addEventListener(_type, handler) { this.handler = handler; }, setTimeout(fn) { timers.push(fn); return timers.length; } } };
