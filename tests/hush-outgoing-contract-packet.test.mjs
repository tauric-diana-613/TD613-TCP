...
assert.equal(packet.eo_rfd_route_state.aperture_context.aperture_version, 'v3.2-alpha');
assert.equal(packet.eo_rfd_route_state.aperture_context.aperture_schema, 'td613-aperture/v3.2-alpha');
assert.equal(packet.eo_rfd_route_state.aperture_context.aperture_feature_version, 'v3.2-alpha-typed-epistemic-deficit-and-stability-aware-widening-runtime');
