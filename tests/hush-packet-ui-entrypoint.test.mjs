...
const fieldCss = fs.readFileSync('app/hush-field-instrument.css', 'utf8');
...
assert.match(appHtml, /hush-field-instrument\.css\?v=202607010320/);
...
assert.match(fieldCss, /hush-packet-drawer-link/);
assert.match(fieldCss, /text-decoration:none/);
