...
assert.match(html, /No live packet, provider return, public release, or seal action is being claimed/);
assert.match(html, /id="copyPacketDrawerBtn"/);
assert.match(html, /id="exportPacketDrawerBtn"/);
...
assert.match(script, /copy\/export creates a local custody receipt only/);
assert.match(script, /No release authority granted/);
