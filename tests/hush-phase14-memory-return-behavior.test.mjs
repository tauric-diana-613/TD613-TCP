...
const queenie = 'I remember the jar first.\n\nThe receipt is FILE-72, and it is not resolved.\n\nBack to the jar: that part matters later because the receipt was evidence, not decoration.';
...
assert.ok(qEval.process_fidelity_score > 0.46);
