...
assert(phase31Ui.includes('Surface Texture'));
assert(phase31Ui.includes('hushPhase31MaskOrnament'));
assert(!phase31Ui.includes('<label>Ornament'));
...
assert(hushHtml.includes('hush-pr123-stable-transform.js'));
