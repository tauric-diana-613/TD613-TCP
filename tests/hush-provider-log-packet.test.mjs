...
assert.equal(packet.eo_rfd_route_observation.aperture_context.aperture_version, 'v3.0-alpha');
assert.equal(packet.eo_rfd_route_observation.aperture_context.aperture_schema, 'td613-aperture/v3.0-alpha');
assert.equal(packet.eo_rfd_route_observation.aperture_context.aperture_feature_version, 'v3.0-alpha-anti-epistemicide-research-runtime');
