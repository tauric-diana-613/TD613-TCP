...
assert.equal(packet.eo_rfd_route_observation.aperture_context.aperture_version, 'v2.9.4');
assert.equal(packet.eo_rfd_route_observation.aperture_context.aperture_schema, 'td613-aperture/v2.9.4');
assert.equal(packet.eo_rfd_route_observation.aperture_context.aperture_feature_version, 'v2.9.4-sigma-dynamical-instrument');
