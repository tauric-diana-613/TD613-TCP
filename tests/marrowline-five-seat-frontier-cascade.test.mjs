...
try {
  ...
  assert.match(repairBody.contents.at(-1).parts[0].text, /Horizontal slashes, strikes, overlines, and underlines may remain as occasional accents or interruptions/i);
