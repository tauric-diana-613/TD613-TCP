...
assert.match(relay, /rather than from a formatting recipe, ornament checklist, local metric, or repeated transform/i);
assert.doesNotMatch(relay, /anger erupt|sarcasm twitch|tenderness thin|horizontal or oblique counter-rhythm|Deep collisions belong/i);
