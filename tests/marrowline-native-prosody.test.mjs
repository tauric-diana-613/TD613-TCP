...
test('real handler rejects repeated shallow repair and returns the next provider’s exact native bytes', async () => {
  ...
  try {
    ...
    assert.deepEqual(calls.map(call => call.model), ['gemini-3.8-flash', 'gemini-3.8-flash', 'gemini-3.5-flash']);
