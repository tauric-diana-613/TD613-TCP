...
assert.equal(release.status, 'IMPLEMENTED_PRODUCTION_DEMONSTRATED');
assert.equal(release.production_status, 'PRODUCTION_DEMONSTRATED');
assert.equal(release.baseline.phase_5, 'IMPLEMENTED_PRODUCTION_DEMONSTRATED');
