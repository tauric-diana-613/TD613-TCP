...
const aperture = read('docs/ASH_KEEP_APERTURE_COMPOSITION.md');
...
assert.match(aperture, /Stretch 5 · Aperture Composition Renovation Before Choir UI/);
assert.match(aperture, /future_choir_ui_mounted: false/);
