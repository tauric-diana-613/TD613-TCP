...
console.log('release-plumbing.test.mjs passed with exact chat relay allowlisting, a non-racing explicit relock recovery command, release-canary-bound exact source, immediate fallback relock, zero-deploy production confirmation, and operator-gated live SRC Zenodo intake');
